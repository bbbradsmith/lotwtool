...
namespace lotwtool
{
    ...
    public enum MusicEnum
    {
        ...
        [Description("$0F breaking the wall")]   VF = 0x0F,
        [Description("$10 erebone")]             V10 = 0x10,
        [Description("$11 archwinger")]          V11 = 0x11,
        [Description("$12 rockgaea")]            V12 = 0x12,
        [Description("$13 teatime")]             V13 = 0x13,
        [Description("$14 unused")]    V14 = 0x14,
        [Description("$15 unused")]    V15 = 0x15,
        [Description("$16 unused")]    V16 = 0x16,
        [Description("$17 unused")]    V17 = 0x17,
        [Description("$18 unused")]    V18 = 0x18,
        [Description("$19 unused")]    V19 = 0x19,
        [Description("$1A unused")]    V1A = 0x1A,
        [Description("$1B unused")]    V1B = 0x1B,
        [Description("$1C unused")]    V1C = 0x1C,
        [Description("$1D unused")]    V1D = 0x1D,
        [Description("$1E unused")]    V1E = 0x1E,
        [Description("$1F unused")]    V1F = 0x1F,
    }
